    ...
    return (
        <div className="bg-white text-black min-h-screen p-10 print:p-0 print:bg-white print:min-h-0 print:h-auto print:overflow-visible font-sans">
            <div className="max-w-[800px] mx-auto text-sm leading-relaxed">
                ...
                <p><strong>Receipt No</strong>: {data.id_payment}</p>
                <br />
                <p className="mb-4">
                    Received with thanks from <strong>{data.nama_client}</strong>.
                </p>
                ...
                <table className="w-full border border-black text-xs mb-8 border-collapse">
                    <thead className="bg-gray-200 text-black font-bold">
                        <tr>
                            ...
                            <th className="border border-black p-3 text-right">Amount (IDR)</th>
                            <th className="border border-black p-3 text-right">Amount (SAR)</th>
                        </tr>
                    </thead>
                    <tbody>
                        <tr>
                            <td className="border border-black p-3">
                                <div className="font-bold mb-1">Payment for:</div>
                                <div className="italic">{data.detail || "Payment"}</div>
                                {(Number(data.exchange_rate) > 1) && (
                                    <div className="text-[10px] text-gray-500 mt-1">Exchange Rate: {Number(data.exchange_rate).toLocaleString()}</div>
                                )}
                            </td>
                ...
                <div className="text-sm mt-6 mb-8">
                    ...
                    <p><strong>ACCOUNT NAME :</strong> VAUZA TAMMA ABADI</p>
                    <p><strong>ACCOUNT NO :</strong> 1440055515156</p>
                </div>
                ...
                <div className="mt-10 mb-2 flex justify-between items-end">
                    <div className="text-xs text-gray-500 w-1/2">
                        ...
                        <p className="italic">* Payment is considered valid only when credited to our account.</p>
                    </div>
